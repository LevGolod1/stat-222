...
R1 <- Rlist$`1990`
mu1 <- apply(R1, 2, mean)
y1 <- rep(mean(mu1), nrow(R1))
fit <- lars(R1, y1, normalize = FALSE, intercept = FALSE)
...
load('./cv/cv_table_7.Rdata')
max(which(!is.na(cvtable[,3])))
...
# print(cvtable)
save(cvtable, file='./cv/cv_table_8.Rdata')
# save(o.list, file='olist_test.Rdata')
save.image('cv_iteration_8.Rdata')

# ##
# load("/Users/levgolod/GoogleDrive/Berkeley/02 Spring Semester/STAT 222 - Capstone/project_share/stock_data/data/sp500/returns/allreturns.Rdata")
# allreturns[1:3,1:7]
# 
# load("/Users/levgolod/GoogleDrive/Berkeley/02 Spring Semester/STAT 222 - Capstone/project_share/stock_data/data/sp500/price/pricelist.Rdata")
# pricelist[[1]]
# pricelist$`AAPL`
# 
# load("/Users/levgolod/GoogleDrive/Berkeley/02 Spring Semester/STAT 222 - Capstone/project_share/stock_data/data/sp500/returns/returnslist.Rdata")
# returnslist[[1]]
# returnslist$`AAPL`[2,'returns']
# (0.3903773-0.4679397)/0.4679397
